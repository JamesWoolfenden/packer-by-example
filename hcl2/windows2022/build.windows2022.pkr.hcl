build {
  ...
  provisioner "powershell" {
    scripts = [
      "${path.root}/scripts/install-updates.ps1"
    ]
  ...
  provisioner "powershell" {
    scripts = [
      "${path.root}/scripts/install-software.ps1"
    ]
    elevated_user     = var.winrm_username
    elevated_password = var.winrm_password
  }
  ...
  provisioner "powershell" {
    scripts = [
      "${path.root}/scripts/install-ssm-agent.ps1"
    ]
    elevated_user     = var.winrm_username
    elevated_password = var.winrm_password
  }
  ...
  provisioner "powershell" {
    scripts = [
      "${path.root}/scripts/install-cloudwatch-agent.ps1"
    ]
    elevated_user     = var.winrm_username
    elevated_password = var.winrm_password
  }
  ...
  provisioner "powershell" {
    scripts = [
      "${path.root}/scripts/security-hardening.ps1"
    ]
    elevated_user     = var.winrm_username
    elevated_password = var.winrm_password
  }
  ...
  provisioner "powershell" {
    scripts = [
      "${path.root}/scripts/configure-windows.ps1"
    ]
    elevated_user     = var.winrm_username
    elevated_password = var.winrm_password
  }
