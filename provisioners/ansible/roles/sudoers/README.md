...
By default this role configures and manages all sudo specifications. These are various
...
| ---------------------------------- | ------------- | ----------------------------------------------------------------------------------------------- | ------------- |
| `sudoer_rewrite_sudoers_file`      | boolean       | Use role default or user defined `default_specs` replacing distribution supplied `/etc/sudoers` file. | True          |
...
comment: string #proceeds the alias with a comment
